...
@BotController
public class PortfolioMediaAdministrationController {

    private static final Logger logger = LoggerFactory.getLogger(PortfolioMediaAdministrationController.class);
    ...
    @BotRequestMapping(value = "portfolio-delete")
...
//        }
    ...
    @BotRequestMapping(value = "portfolio-restore")
...
//        }
    ...
    @BotRequestMapping(value = "portfolio-/rassylka")
