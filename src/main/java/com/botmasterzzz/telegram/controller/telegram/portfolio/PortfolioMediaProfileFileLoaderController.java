...
@BotController
public class PortfolioMediaProfileFileLoaderController {

    private static final Logger logger = LoggerFactory.getLogger(PortfolioMediaProfileFileLoaderController.class);
    ...
    public PortfolioMediaProfileFileLoaderController(TelegramMediaService telegramMediaService, DatabaseService databaseService, TelegramUserService telegramUserService, Gson gson) {
    ...
    @BotRequestMapping(value = "portfolio-more")
    public PartialBotApiMethod getProfileMedia(Update update) {
        ...
        List<TelegramUserMediaEntity> telegramUserMediaEntityList = telegramMediaService.portfolioPersonalMediaList(mediaForTelegramUser);
    ...
    @BotRequestMapping(value = "portfolio-prfl")
