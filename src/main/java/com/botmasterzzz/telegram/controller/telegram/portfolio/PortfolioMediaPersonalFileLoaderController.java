...
@BotController
public class PortfolioMediaPersonalFileLoaderController {

    private static final Logger logger = LoggerFactory.getLogger(PortfolioMediaPersonalFileLoaderController.class);
    ...
    public PortfolioMediaPersonalFileLoaderController(TelegramMediaService telegramMediaService, DatabaseService databaseService, TelegramUserService telegramUserService, Gson gson) {
    ...
    @BotRequestMapping(value = {"portfolio-\uD83C\uDF81Мои медиа", "portfolio-\uD83C\uDF81My media", "portfolio-\uD83C\uDF81我的媒體"})
    public PartialBotApiMethod getPersonalMedia(Update update) {
        ...
        List<TelegramUserMediaEntity> telegramUserMediaEntityList = telegramMediaService.portfolioPersonalMediaList(requestedTelegramUser);
    ...
    @BotRequestMapping(value = "portfolio-next")
