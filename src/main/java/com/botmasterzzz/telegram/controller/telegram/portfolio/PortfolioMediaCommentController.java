...
@BotController
public class PortfolioMediaCommentController {

    private static final Logger logger = LoggerFactory.getLogger(PortfolioMediaCommentController.class);
    ...
    public PortfolioMediaCommentController(TelegramMediaService telegramMediaService, Gson gson, DatabaseService databaseService, TelegramUserService telegramUserService) {
    ...
    @BotRequestMapping(value = "portfolio-comment")
    ...
    @BotRequestMapping(value = "portfolio-arrow")
    ...
    @BotRequestMapping(value = "portfolio-comment-write")
...
//        keyboard.setKeyboard(keyboardRows);
    ...
    @BotRequestMapping(value = "portfolio-comment-upload")
